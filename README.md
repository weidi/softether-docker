...
`docker run -d --rm --name softether-vpn-server -v softetherdata:/mnt -p 444:443/tcp -p 992:992/tcp -p 1194:1194/udp -p 5555:5555/tcp -p 500:500/udp -p 4500:4500/udp -p 1701:1701/udp --cap-add NET_ADMIN toprock/softether`
